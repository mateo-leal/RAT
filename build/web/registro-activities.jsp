...
<html lang="en">
    ...
    <head>
        ...
        <title>Asignaci髇 de actividades</title>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="../images/logo.png" alt="Pinvalidda" width="130"></a>
                </div>
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li><a href="login.html"><i class="fa fa-sign-out fa-fw"></i> Cerrar sesi贸n</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                    ...
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="inactive">
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="activities.html"><i class="fa fa-search fa-fw"></i>Consultar asignaci贸n de actividades</a>
                                    </li>
                                    <li>
                                        <a href="register_activities.html"><i class="fa fa-list-ul fa-fw"></i> Asignaci贸n de actividades</a>
                                    </li>
                                    <li>
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Asignaci贸n de actividades</h1>
                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <form role="form">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control" placeholder="ID del empleado">
                                                </div>
                                                <div class="form-group">
                                                    <input class="form-control" placeholder="ID de la actividad">
                                                </div>
                                                <div class="form-group">
                                                    <input class="form-control" placeholder="Usuario creador">
                                                </div>
                                                <div class="form-group">
