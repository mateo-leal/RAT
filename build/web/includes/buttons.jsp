...
<button input type="submit" name="action" value="guardar" class="btn btn-default">Guardar</button>
<button input type="submit" name="action" value="cancelar" class="btn btn-default">Limpiar</button>
