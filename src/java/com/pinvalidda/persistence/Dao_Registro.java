...
import com.pinvalidda.model.Registro;
...
public class Dao_Registro {
    ...
    public Registro getRegistro(Connection c, String idempleado) {
    ...
    public Registro getEliminarRegistro(Connection c, String idempleado) {
        Registro u = new Registro();
        try {
